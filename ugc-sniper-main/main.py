 ...
 class Sniper:
    ...
    def run_bot(self):
        ...
        async def stats(ctx):
            ...
            embed.set_author(name=f"Federal Sniper {self.version}")
            ...
            while True:
                ...
                if not json_response["purchased"]:
                       ...
                       if self.webhookEnabled:
                            embed_data = {
                                "title": "New Item Purchased with Federals Ugc Sniper",
                                "url": f"https://www.roblox.com/catalog/{item_id}/Federal-Sniper",
                                "color": 65280,
                                "author": {
                                    "name": "Purchased limited successfully!"
                                },
                                "footer": {
                                "text": "Federals Ugc Sniper"
                                }
                            }
